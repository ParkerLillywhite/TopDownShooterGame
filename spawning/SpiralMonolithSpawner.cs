...
public class SpiralMonolithSpawner : MonoBehaviour
{
    public static SpiralMonolithSpawner SharedInstance;
    ...
    void Spawn(){  
        GameObject monolith = SpiralMonolithPool.SharedInstance.GetPooledObject();
